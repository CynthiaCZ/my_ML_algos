"""
   ...
   The model is being applied to the German Credit dataset
   https://archive.ics.uci.edu/dataset/144/statlog+german+credit+data
   The prediction task is to predict whether someone's credit is good (1) or bad (0)
   based on attributes like sex, age, and personal status
"""
